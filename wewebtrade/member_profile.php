...
<section class="content outline">
    ...
    <div class='profile'>
        ...
        <?php
         include_once 'includes/db_functions.php';
         //Testing hard coded editProfile
         editProfile(15);
         ...
         if(isset($alumni_id)){
            ...
            foreach($profile as $row2){
                ...
                if (!empty($row2['profile_pic']) && $row2['profile_pic'] != "/images/profile/") { 
                    ...
                    echo "<img class='shadow' src='images/profile_mark.png' width='100' height='100' alt='Profile Pic' />";
                }
         ...
         ?>
         <p><a href="http://www.wewebtrade.com/create_profile_form.php">Register</a> to create a profile or <br> <a href="http://www.wewebtrade.com/index.php?action=login">Login</a> to edit your profile.</p>
        ...
        if (isset($row2['first_name'])) {
           echo "<br /><p><button><a href='http://wewebtrade.com/edit_profile.php'>Edit Profile</a></button>";
